...
export default function Page() {
  return (
    <main  style={{ whiteSpace: "pre-line" }} className="container relative mx-auto scroll-my-12 overflow-auto p-4 print:p-12 md:p-16">
          ...
          {RESUME_DATA.work.map((work) => {
            return (
              <Card key={work.company}>
                ...
                <CardContent className="mt-2 text-xs pl-2">
                  {work.description}
                </CardContent>
              </Card>
            );
